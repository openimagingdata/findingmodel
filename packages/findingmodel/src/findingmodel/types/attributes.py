"""Attribute types for finding models.

Defines the attribute types (choice and numeric) that characterize radiology
findings, along with their ID'd variants for the registry.
"""
