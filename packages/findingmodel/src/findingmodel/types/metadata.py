...
class Subspecialty(str, Enum):
    """RSNA-aligned specialty content codes retained for finding-model metadata."""
    ...
    def meaning(self) -> str:
        return _SUBSPECIALTY_MEANINGS[self]


_SUBSPECIALTY_MEANINGS: dict[Subspecialty, str] = {
    Subspecialty.BR: "Breast (Imaging and Interventional)",
    Subspecialty.CA: "Cardiac Radiology",
    Subspecialty.CH: "Chest Radiology",
    Subspecialty.ER: "Emergency Radiology",
    Subspecialty.GI: "Gastrointestinal Radiology",
    Subspecialty.GU: "Genitourinary Radiology",
    Subspecialty.HN: "Head and Neck",
    Subspecialty.IR: "Interventional",
    Subspecialty.MI: "Molecular Imaging",
    Subspecialty.MK: "Musculoskeletal Radiology",
    Subspecialty.NM: "Nuclear Medicine",
    Subspecialty.NR: "Neuroradiology",
    Subspecialty.OB: "Obstetric/Gynecologic Radiology",
    Subspecialty.OI: "Oncologic Imaging",
    Subspecialty.PD: "Pediatric Radiology",
    Subspecialty.SQ: "Quality Assurance/Quality Improvement (including radiation and general safety issues)",
    Subspecialty.VA: "Vascular",
}
