...
@anatomic.group("query")
def anatomic_query() -> None:
    """Query anatomic locations."""
    pass


@anatomic_query.command("ancestors")
@click.argument("location_id")
@click.option("--db-path", type=click.Path(path_type=Path), help="Database path (default: config setting)")
def anatomic_query_ancestors(location_id: str, db_path: Path | None) -> None:
...
@anatomic_query.command("descendants")
@click.argument("location_id")
@click.option("--db-path", type=click.Path(path_type=Path), help="Database path (default: config setting)")
def anatomic_query_descendants(location_id: str, db_path: Path | None) -> None:
...
@anatomic_query.command("laterality")
@click.argument("location_id")
@click.option("--db-path", type=click.Path(path_type=Path), help="Database path (default: config setting)")
def anatomic_query_laterality(location_id: str, db_path: Path | None) -> None:
...
@anatomic_query.command("code")
@click.argument("system")
@click.argument("code")
@click.option("--db-path", type=click.Path(path_type=Path), help="Database path (default: config setting)")
def anatomic_query_code(system: str, code: str, db_path: Path | None) -> None:
