...
def load_fm_json(filename: str) -> str:
    ...
    """
    # Test data is in the findingmodel package, not findingmodel-ai
    # Navigate from findingmodel-ai/evals to packages/findingmodel/tests/data/defs
    # __file__ is .../packages/findingmodel-ai/evals/utils.py
    # parent is .../packages/findingmodel-ai/evals
    # parent.parent is .../packages/findingmodel-ai
    # parent.parent.parent is .../packages
    packages_dir = Path(__file__).parent.parent.parent
    test_data_dir = packages_dir / "findingmodel" / "tests" / "data" / "defs"
