...
def load_output_file(output_path: Path) -> dict[str, Any]:
...
def save_output_file(output_path: Path, data: dict[str, Any]) -> None:
    """Save the output JSON file."""
    with open(output_path, "w") as f:
        json.dump(data, f, indent=2)


def is_already_enriched(finding_name: str, existing_output: dict[str, Any]) -> str | None:
